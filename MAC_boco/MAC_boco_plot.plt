...
splot "MAC_boco_5000.csv"
unset table

set contour base
set cntrparam level incremental -2.5, 0.08, 1.5
unset surface
...
set palette defined ( 0 '#000090',1 '#000fff',2 '#0090ff',3 '#0fffee',3.75 '#ffffff',5 '#ffee00',6 '#ee0000')
...
set yrange [-10:10]
set table 'colormap.dat'
splot "MAC_boco_omega.csv"
unset table

set contour base
set cntrparam level incremental -8.5, 0.2, 7.5 # 等高線の間隔は少し大きめに
unset surface
set table 'contour.dat'
splot "MAC_boco_omega.csv"
unset table
...
# set palette defined (0 '#0fffee',1 '#0090ff', 2 '#000fff',3 '#000090',4 '#ffffff',5 '#7f0000', 6 '#ee0000', 7 '#ff7000', 8 '#ffee00')
# set palette defined ( 0 '#000090',1 '#000fff',2 '#0090ff',3 '#0fffee',4 '#ffffff',5 '#ffee00',6 '#ff7000',7 '#ee0000',8 '#7f0000')
set palette defined ( 0 '#000090',1 '#000fff',2 '#0090ff',3 '#0fffee',3.88 '#ffffff',5 '#ffee00',7 '#ee0000')
plot 'colormap.dat' with image, 'contour.dat' with lines lt -1 lw 1
